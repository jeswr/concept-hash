 ...
 */
import { CHART_EDITION_PIN, PRIMES } from './primes.js';
import { blankNode, defaultGraph, literal, namedNode } from './quads.js';
import { CHART_EDITION, CHART_INDEX, CONCEPT_DEFINITION, cdef, EXPONENT, MINT_SCHEME, PRIME_CATEGORY, RDF_FIRST, RDF_NIL, RDF_REST, RDF_TYPE, SEMANTIC_STATUS, STATUS_PRIME, XSD_NON_NEG_INT, } from './vocab.js';
export const primeSymbolicName = (name) => `prime:${name}`;
/** Build the authored record (quads) for one prime lexicon entry. */
export function primeRecord(entry) {
...
export function standardPrimeMintSet() {
